const int buttonSaya = D2; // mengubah ‘buttonSaya’ menjadi variabel pin 2
const int ledSaya = D3; // mengubah ‘ledSaya’ menjadi variabel pin 3
...
{
digitalWrite(ledPin, LOW); //apabila tidak ada, maka ‘ledSaya’ mati
}
}